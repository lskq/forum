...
export default function input() {
    ...
    return (
        <form action={push} className="w-full md:w-5/6">
            ...
            <button onClick={useRouter().refresh}  type="submit" className="h-2/3 bg-foreground text-background rounded-md p-1 hover:bg-gray-500 active:bg-amber-300 active:text-black mb-4 mr-4">
                Post
            </button>
